...
export function AboutContent() {
  ...
  const aboutTexts = {
    en: {
      ...
      voiceSupportDesc: "Search and listen to information in English, Yoruba, Pidgin, Hausa, or Igbo",
      turnByTurn: "Turn-by-Turn Directions",
      turnByTurnDesc: "Get navigation assistance directly to your polling unit",
      multilingual: "Multilingual",
      multilingualDesc: "Full support for English, Yoruba, Nigerian Pidgin, Hausa, and Igbo",
    ...
    yo: {
      ...
      voiceSupportDesc: "Wá kí o sì gbọ́ àlàyé ní Gẹ̀ẹ́sì, Yorùbá, Pidgin, Hausa, tàbí Igbo",
      turnByTurn: "Ìtọ́sọ́nà",
      turnByTurnDesc: "Gba ìrànlọ́wọ́ ìtọ́sọ́nà tààrà sí ibi ìdìbò rẹ",
      multilingual: "Èdè Púpọ̀",
      multilingualDesc: "Àtìlẹ́yìn kíkún fún Gẹ̀ẹ́sì, Yorùbá, Pidgin Nigeria, Hausa, àti Igbo",
    ...
    pcm: {
      ...
      voiceSupport: "Voice Support",
      voiceSupportDesc: "Search and listen to information for English, Yoruba, Pidgin, Hausa, or Igbo",
      turnByTurn: "Turn-by-Turn Directions",
